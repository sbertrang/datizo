...
{
	return hash_uint32((int32_t) PG_GETARG_CHAR(0));
}

Datum
hashint2(PG_FUNCTION_ARGS)
{
	return hash_uint32((int32_t) PG_GETARG_INT16(0));
}
...
{
	return hash_uint32((uint32_t) PG_GETARG_OID(0));
}
